...
public:
     ...
     */
protected:
    ALDerenderEntry(EEntryType eType, bool fPersists);
    ALDerenderEntry(EEntryType eType, const LLSD& sdData);
public:
    virtual ~ALDerenderEntry() = default;
...
public:
    ...
    static std::unique_ptr<ALDerenderEntry> fromLLSD(const LLSD& sdData);
...
class ALDerenderObject : public ALDerenderEntry
{
    /*
     * Constructors
     */
public:
    ALDerenderObject(const LLSelectNode* pNode, bool fPersist);
    ALDerenderObject(const LLSD& sdData);
...
class ALDerenderAvatar : public ALDerenderEntry
{
public:
    ALDerenderAvatar(bool fPersists)
...
class ALDerenderList : public LLSingleton<ALDerenderList>
{
    LLSINGLETON(ALDerenderList);
protected:
    /*virtual*/ ~ALDerenderList();
