...
#ifndef AL_FLOATERLEGACYPROFILE_H
#define AL_FLOATERLEGACYPROFILE_H

#include "llfloater.h"

class LLAvatarName;
class ALPanelProfileLegacy;
...
private:
    ~ALFloaterProfileLegacy() override;
    void onAvatarNameCache(const LLUUID& agent_id, const LLAvatarName& av_name);

    ALPanelProfileLegacy* mPanel;
