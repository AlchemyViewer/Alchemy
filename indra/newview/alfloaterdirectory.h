...
#ifndef AL_FLOATERDIRECTORY_H
#define AL_FLOATERDIRECTORY_H
...
private:
    ...
    friend class ALPanelSearchLandSales;
    friend class ALPanelSearchPeople;
    friend class ALPanelSearchPlaces;
...
public:
    ...
    ALFloaterDirectory(const Params& key);
...
private:
    ...
    ALPanelSearchWeb* mPanelWeb;
    LLScrollListCtrl* mResultList;
    LLTextBase* mResultsStatus;
};

#endif // AL_FLOATERDIRECTORY_H
