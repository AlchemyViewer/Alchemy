...
#ifndef AL_PANELSEARCHPLACES_H
#define AL_PANELSEARCHPLACES_H
...
class ALPanelSearchPlaces final : public ALPanelSearch
{
public:
    AL_VIEW_TYPE(ALPanelSearchPlaces, ALPanelSearch);
