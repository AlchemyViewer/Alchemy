...
#ifndef AL_PANELSEARCHBASE_H
#define AL_PANELSEARCHBASE_H

#include "llpanel.h"

class LLUICtrl;
class ALFloaterDirectory;
...
protected:
    virtual ~ALPanelSearch() = default;
    ALFloaterDirectory* mFloater;
