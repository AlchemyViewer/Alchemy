...
#ifndef AL_PANELPROFILELEGACY_H
#define AL_PANELPROFILELEGACY_H

#include "llgroupmgr.h"
#include "alpanelavatarlegacy.h"
#include "llprofileimagepicker.h"

class ALClassifiedItem;
class ALPanelClassifiedEdit;
class ALPanelClassifiedInfo;
class ALPanelPickEdit;
class ALPanelPickInfo;
class ALPickItem;
class LLAvatarName;
...
public:
    ...
    void setProfileImageUploaded(const LLUUID& id, EProfileImageType type);
...
public:
    class ALPanelProfilePicks final : public ALPanelProfileLegacyTab
    {
    ...
    private:
        ...
        void setProfilePanel(ALPanelProfileLegacy* profile_panel);
        ALPanelProfileLegacy* getProfilePanel() const;
        void onPanelPickClose(LLPanel* panel);
        void onPanelPickSave(LLPanel* panel);
        void onPanelPickEditSave(ALPanelPickEdit* panel);
        void onPanelEdit();
        ...
        void onPanelClassifiedSave(ALPanelClassifiedEdit* panel);
        void onPanelClassifiedClose(ALPanelClassifiedInfo* panel);
        void onDoubleClickClassifiedItem(LLUICtrl* item);
        ALClassifiedItem* findClassifiedById(const LLUUID& classified_id) const;
        ALClassifiedItem* getSelectedClassifiedItem() const;
        ALPickItem* getSelectedPickItem() const;

        void createPickEditPanel();
        void createClassifiedEditPanel(ALPanelClassifiedEdit** panel);
        ...
        ALPanelProfileLegacy* mProfilePanel;
        LLFlatListView* mClassifiedsList;
        LLFlatListView* mPicksList;
        ALPanelPickEdit* mPanelPickEdit;
        ALPanelPickInfo* mPanelPickInfo;
        ALPanelClassifiedInfo* mPanelClassifiedInfo;
        LLHandle<LLView> mPopupMenuHandle;
        ...
        std::map<LLUUID, ALPanelClassifiedEdit*> mEditClassifiedPanels;
    };

    class ALPanelProfileGroups final : public ALPanelProfileLegacyTab
    {
        friend class ALPanelProfileLegacy;
    public:
...
private:
    ALPanelProfilePicks* mPanelPicks;
    ALPanelProfileGroups* mPanelGroups;
};
