/*
 * @file alfloaterprofilelegacy.cpp
...
ALFloaterProfileLegacy::~ALFloaterProfileLegacy()
{
...
void ALFloaterProfileLegacy::onOpen(const LLSD& key)
{
...
void ALFloaterProfileLegacy::onAvatarNameCache(const LLUUID& agent_id, const LLAvatarName& av_name)
{
    setTitle(av_name.getCompleteName());
    mAvatarNameCacheConnection.disconnect();
}

LLPanel* ALFloaterProfileLegacy::expandTab(const std::string& name) const
{
    return mPanel != nullptr ? mPanel->expandTab(name) : nullptr;
}

LLPanel* ALFloaterProfileLegacy::getExpandedTab() const
{
