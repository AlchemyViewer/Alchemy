/**
 * @file allegacynotificationwellwindow.h
...
#ifndef AL_NOTIFICATIONWELLWINDOW_H
#define AL_NOTIFICATIONWELLWINDOW_H
...
protected:
    ...
    {
        WellNotificationChannel(ALLegacyNotificationWellWindow*);
        void onDelete(LLNotificationPtr notify)
        {
            mWellWindow->removeItemByID(notify->getID());
        }

        ALLegacyNotificationWellWindow* mWellWindow;
    };
...
#endif // AL_NOTIFICATIONWELLWINDOW_H
