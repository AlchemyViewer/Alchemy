...
,   mWebBrowser(nullptr)
{
    ...
    mCommitCallbackRegistrar.add("WebContent.Back", boost::bind(&ALPanelSearchWeb::onClickBack, this));
    mCommitCallbackRegistrar.add("WebContent.Forward", boost::bind(&ALPanelSearchWeb::onClickForward, this));
    mCommitCallbackRegistrar.add("WebContent.Reload", boost::bind(&ALPanelSearchWeb::onClickReload, this));
    mCommitCallbackRegistrar.add("WebContent.Stop", boost::bind(&ALPanelSearchWeb::onClickStop, this));
}

bool ALPanelSearchWeb::postBuild()
{
...
void ALPanelSearchWeb::loadUrl(const SearchQuery& p)
{
...
// virtual
void ALPanelSearchWeb::handleMediaEvent(LLPluginClassMedia* self, EMediaEvent event)
{
...
void ALPanelSearchWeb::onClickForward() const
{
    mWebBrowser->navigateForward();
}

void ALPanelSearchWeb::onClickBack() const
{
    mWebBrowser->navigateBack();
}

void ALPanelSearchWeb::onClickReload() const
{
...
void ALPanelSearchWeb::onClickStop()
{
    if( mWebBrowser->getMediaPlugin() )
