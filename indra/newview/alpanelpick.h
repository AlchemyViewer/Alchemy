/**
 * @file alpanelpick.h
 * @brief ALPanelPick class definition
 *
...
#ifndef AL_ALPANELPICK_H
#define AL_ALPANELPICK_H
 ...
 */
class ALPanelPickInfo : public LLPanel, public LLAvatarPropertiesObserver, LLRemoteParcelInfoObserver
{
 ...
 */
class ALPanelPickEdit final : public ALPanelPickInfo
{
...
public:
     ...
     * Creates new panel
     */
    static ALPanelPickEdit* create();

    ~ALPanelPickEdit() = default;
