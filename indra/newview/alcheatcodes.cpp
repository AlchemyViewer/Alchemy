...
class ALXyzzyHandler : public LLCommandHandler
{
public:
    ALXyzzyHandler() : LLCommandHandler("xyzzy", UNTRUSTED_THROTTLE) {}
...
class ALDyeMenuHandler : public LLCommandHandler
{
public:
    ALDyeMenuHandler() : LLCommandHandler("dyemenu", UNTRUSTED_THROTTLE) {}
...
ALXyzzyHandler   gXyzzyHandler;
ALDyeMenuHandler gDyeMenuHandler;
