...
S32 LLViewerParcelOverlay::renderPropertyLines	() 
{
	...
	F32 camera_z = LLViewerCamera::getInstanceFast()->getOrigin().mV[VZ];
	...
	const LLVector3& CAMERA_AT = LLViewerCamera::getInstanceFast()->getAtAxis();
	...
	LLVector3 cull_plane_point = LLViewerCamera::getInstanceFast()->getAtAxis();
