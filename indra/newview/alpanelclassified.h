/**
 * @file alpanelclassified.h
 * @brief ALPanelClassifiedInfo class definition
 *
...
#ifndef AL_PANEL_CLASSIFIED_INFO_H
#define AL_PANEL_CLASSIFIED_INFO_H
...
class ALPanelClassifiedInfo : public LLPanel, public LLAvatarPropertiesObserver
{
...
private:
    ...
    typedef std::list<ALPanelClassifiedInfo*> panel_list_t;
    static panel_list_t sAllPanels;
};

#endif // AL_PANEL_CLASSIFIED_INFO_H
