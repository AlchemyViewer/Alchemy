...
namespace tut
{
    ...
    {
        Kernel k = bakeKernel(0, 0.f, 0.f, 1.f);
    ...
    void dofbokeh_object::test<2>()
    {
        for (S32 n = 0; n < 3; ++n)
        {
            Kernel k = bakeKernel(n, 0.5f, 0.f, 1.f);
    ...
    {
        Kernel k = bakeKernel(6, 0.f, 0.f, 1.f);
    ...
    {
        Kernel k = bakeKernel(6, 0.f, 90.f, 1.f);
    ...
    {
        Kernel k = bakeKernel(0, 0.f, 0.f, 1.6f);
    ...
    void dofbokeh_object::test<6>()
    {
        ...
        Kernel hi = bakeKernel(999, 5.f, 0.f, 99.f);
        ...
        Kernel lo = bakeKernel(6, -1.f, 0.f, 0.01f);
