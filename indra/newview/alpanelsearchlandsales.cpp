/*
 * @file alpanelsearchlandsales.cpp
...
#include "alpanelsearchlandsales.h"
...
:   ALPanelSearch()
{
    mCommitCallbackRegistrar.add("Search.query", boost::bind(&ALPanelSearchLandSales::onCommitSearch, this, _1));
}

bool ALPanelSearchLandSales::postBuild()
{
    return LLPanel::postBuild();
}

void ALPanelSearchLandSales::onCommitSearch(LLUICtrl* ctrl)
{
    search();
}

void ALPanelSearchLandSales::search()
{
    LLDirQuery query;
