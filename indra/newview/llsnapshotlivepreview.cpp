...
void LLSnapshotLivePreview::draw()
{
        ...
        getSnapshotUpToDate())
    {
        ...
        gGL.getTexUnit(0)->bindSampled(getCurrentImage(), ALSamplers::AnisoClamp);
        // calculate UV scale
    ...
    if (mFallAnimTimer.getStarted())
    {
        ...
        if (mViewerImage[old_image_index].notNull() && mFallAnimTimer.getElapsedTimeF32() < FALL_TIME)
        {
            ...
            gGL.color4fv(image_color.mV);
            gGL.getTexUnit(0)->bindSampled(mViewerImage[old_image_index], ALSamplers::AnisoClamp);
            // calculate UV scale
...
void LLSnapshotLivePreview::prepareFreezeFrame()
{
    ...
    if (!scaled->isBufferInvalid())
    {
        ...
        gGL.getTexUnit(0)->bindSampled(curr_preview_image, preview_sampler);
