...
ALFloaterGroupProfile::ALFloaterGroupProfile(LLSD const& key)
    : LLFloater(key)
{
}

ALFloaterGroupProfile::~ALFloaterGroupProfile()
{
}

bool ALFloaterGroupProfile::postBuild()
{
...
void ALFloaterGroupProfile::onOpen(const LLSD& key)
{
    if (key.isMap())
    {
...
void ALFloaterGroupProfile::setGroupName(const std::string& group_name)
{
    if (mCreatingGroup)
    {
        setTitle(getString("title_create_group"));
...
void ALFloaterGroupProfile::createGroup() const
{
    LLSD params;
...
//static
LLFloater* ALFloaterGroupProfile::showInstance(const LLSD& key, bool focus)
{
