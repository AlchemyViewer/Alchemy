...
#ifndef AL_FLOATERPROGRESSVIEW_H
#define AL_FLOATERPROGRESSVIEW_H
...
private:
    ~ALFloaterProgressView() = default;
    void onCommitCancel(LLUICtrl* ctrl);

    LLProgressBar* mProgressBar = nullptr;
    LLTextBase* mProgressText = nullptr;
    LLTextBase* mLocationText = nullptr;
    LLButton* mCancelBtn = nullptr;
};

#endif // AL_FLOATERPROGRESSVIEW_H
