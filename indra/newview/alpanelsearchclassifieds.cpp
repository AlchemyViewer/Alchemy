/*
 * @file alpanelsearchclassifieds.cpp
 * @brief Classifieds search panel
 *
...
#include "alpanelsearchclassifieds.h"
...
static LLPanelInjector<ALPanelSearchClassifieds> t_panel_search_classifieds("panel_al_search_classifieds");

ALPanelSearchClassifieds::ALPanelSearchClassifieds()
    : ALPanelSearch()
    , mSearchEditor(nullptr)
    , mClassifiedsCategory(nullptr)
{
    mCommitCallbackRegistrar.add("Search.query", boost::bind(&ALPanelSearchClassifieds::onCommitSearch, this, _1));
}

bool ALPanelSearchClassifieds::postBuild()
{
    ...
    //mSearchEditor->setKeystrokeCallback(boost::bind(&ALPanelSearchClassifieds::onCommitSearch, this, _1));

    return LLPanel::postBuild();
}

void ALPanelSearchClassifieds::onCommitSearch(LLUICtrl* ctrl)
{
...
void ALPanelSearchClassifieds::search()
{
    LLDirQuery query;
