/**
 * @file alpanelavatarlegacy.h
 * @brief ALPanelProfileLegacyTab and related class definitions
 *
...
#ifndef AL_ALPANELAVATARLEGACY_H
#define AL_ALPANELAVATARLEGACY_H
...
public:
    ...
    ~ALPanelProfileLegacyTab() override;
...
#endif // AL_ALPANELAVATARLEGACY_H
