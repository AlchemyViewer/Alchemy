...
class LLPanelPresetsPulldown final : public LLPanelPulldown
{
 public:
    AL_VIEW_TYPE(LLPanelPresetsPulldown, LLPanelPulldown);
 ...
 private:
    ...
    void onLightboxButtonClick(const LLSD& user_data);
