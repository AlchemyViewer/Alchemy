...
#ifndef AL_CLASSIFIEDITEM_H
#define AL_CLASSIFIEDITEM_H

#include "llavatarpropertiesprocessor.h"
#include "llpanel.h"

class ALPanelClassifiedEdit;
...
public:
    ...
    void fillIn(ALPanelClassifiedEdit* panel);
