...
static LLPanelInjector<ALPanelSearchPlaces> t_panel_al_search_places("panel_al_search_places");

ALPanelSearchPlaces::ALPanelSearchPlaces()
:   ALPanelSearch()
{
    mCommitCallbackRegistrar.add("Search.query", boost::bind(&ALPanelSearchPlaces::onCommitSearch, this, _1));
}

bool ALPanelSearchPlaces::postBuild()
{
    ...
    //mSearchEditor->setKeystrokeCallback(boost::bind(&ALPanelSearchPlaces::onCommitSearch, this, _1));
...
void ALPanelSearchPlaces::search()
{
    LLDirQuery query;
