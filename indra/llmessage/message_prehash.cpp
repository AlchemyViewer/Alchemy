...
char const *const _PREHASH_CombatSettings = LLMessageStringTable::getInstance()->getString("CombatSettings");
char const *const _PREHASH_CombatFlags = LLMessageStringTable::getInstance()->getString("CombatFlags");
char const *const _PREHASH_OnDeath = LLMessageStringTable::getInstance()->getString("OnDeath");
...
char const* const _PREHASH_MediaData = LLMessageStringTable::getInstance()->getString("MediaData");
char const* const _PREHASH_MediaType = LLMessageStringTable::getInstance()->getString("MediaType");
char const* const _PREHASH_MediaDesc = LLMessageStringTable::getInstance()->getString("MediaDesc");
char const* const _PREHASH_MediaWidth = LLMessageStringTable::getInstance()->getString("MediaWidth");
char const* const _PREHASH_MediaHeight = LLMessageStringTable::getInstance()->getString("MediaHeight");
char const* const _PREHASH_MediaLoop = LLMessageStringTable::getInstance()->getString("MediaLoop");
char const* const _PREHASH_MediaLinkSharing = LLMessageStringTable::getInstance()->getString("MediaLinkSharing");
char const* const _PREHASH_MediaCurrentURL = LLMessageStringTable::getInstance()->getString("MediaCurrentURL");
char const* const _PREHASH_MediaAllowNavigate = LLMessageStringTable::getInstance()->getString("MediaAllowNavigate");
char const* const _PREHASH_MediaPreventCameraZoom = LLMessageStringTable::getInstance()->getString("MediaPreventCameraZoom");
char const* const _PREHASH_MediaURLTimeout = LLMessageStringTable::getInstance()->getString("MediaURLTimeout");
char const* const _PREHASH_DataExtended = LLMessageStringTable::getInstance()->getString("DataExtended");
char const* const _PREHASH_DataBlockExtended = LLMessageStringTable::getInstance()->getString("DataBlockExtended");
char const* const _PREHASH_ColoName = LLMessageStringTable::getInstance()->getString("ColoName");
char const* const _PREHASH_CPUClassID = LLMessageStringTable::getInstance()->getString("CPUClassID");
char const* const _PREHASH_CPURatio = LLMessageStringTable::getInstance()->getString("CPURatio");
char const* const _PREHASH_ProductName = LLMessageStringTable::getInstance()->getString("ProductName");
char const* const _PREHASH_ChannelVersion = LLMessageStringTable::getInstance()->getString("ChannelVersion");
char const* const _PREHASH_TransactionInfo = LLMessageStringTable::getInstance()->getString("TransactionInfo");
char const* const _PREHASH_IsSourceGroup = LLMessageStringTable::getInstance()->getString("IsSourceGroup");
char const* const _PREHASH_IsDestGroup = LLMessageStringTable::getInstance()->getString("IsDestGroup");
char const* const _PREHASH_ItemDescription = LLMessageStringTable::getInstance()->getString("ItemDescription");
char const* const _PREHASH_TimeStamp = LLMessageStringTable::getInstance()->getString("TimeStamp");
char const* const _PREHASH_MonoScore = LLMessageStringTable::getInstance()->getString("MonoScore");
char const* const _PREHASH_PublicURLs = LLMessageStringTable::getInstance()->getString("PublicURLs");
char const* const _PREHASH_NewData = LLMessageStringTable::getInstance()->getString("NewData");
char const* const _PREHASH_ListInProfile = LLMessageStringTable::getInstance()->getString("ListInProfile");
char const* const _PREHASH_ModifyBlockExtended = LLMessageStringTable::getInstance()->getString("ModifyBlockExtended");
char const* const _PREHASH_SurfaceInfo = LLMessageStringTable::getInstance()->getString("SurfaceInfo");
char const* const _PREHASH_UVCoord = LLMessageStringTable::getInstance()->getString("UVCoord");
char const* const _PREHASH_STCoord = LLMessageStringTable::getInstance()->getString("STCoord");
char const* const _PREHASH_Normal = LLMessageStringTable::getInstance()->getString("Normal");
char const* const _PREHASH_Binormal = LLMessageStringTable::getInstance()->getString("Binormal");
char const* const _PREHASH_OwnerData = LLMessageStringTable::getInstance()->getString("OwnerData");
char const* const _PREHASH_Options = LLMessageStringTable::getInstance()->getString("Options");
char const* const _PREHASH_CastsShadows = LLMessageStringTable::getInstance()->getString("CastsShadows");
char const* const _PREHASH_ExtraPhysics = LLMessageStringTable::getInstance()->getString("ExtraPhysics");
char const* const _PREHASH_PhysicsShapeType = LLMessageStringTable::getInstance()->getString("PhysicsShapeType");
char const* const _PREHASH_Density = LLMessageStringTable::getInstance()->getString("Density");
char const* const _PREHASH_Friction = LLMessageStringTable::getInstance()->getString("Friction");
char const* const _PREHASH_Restitution = LLMessageStringTable::getInstance()->getString("Restitution");
