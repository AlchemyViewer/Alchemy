...
char const* const _PREHASH_AgentEffectiveMaturity = LLMessageStringTable::getInstance()->getString("AgentEffectiveMaturity");
...
char const* const _PREHASH_NewGroupData = LLMessageStringTable::getInstance()->getString("NewGroupData");
...
char const* const _PREHASH_PidStat = LLMessageStringTable::getInstance()->getString("PidStat");
...
char const* const _PREHASH_TopPick = LLMessageStringTable::getInstance()->getString("TopPick");
...
char const* const _PREHASH_HardMaxObjects = LLMessageStringTable::getInstance()->getString("HardMaxObjects");
...
char const* const _PREHASH_MaxAgents32 = LLMessageStringTable::getInstance()->getString("MaxAgents32");
...
char const* const _PREHASH_ChangLLInventoryItemFlags = LLMessageStringTable::getInstance()->getString("ChangLLInventoryItemFlags");
char const* const _PREHASH_ChangeInventoryItemFlags = LLMessageStringTable::getInstance()->getString("ChangeInventoryItemFlags");
...
char const* const _PREHASH_ObjectIncludeInSearch = LLMessageStringTable::getInstance()->getString("ObjectIncludeInSearch");
