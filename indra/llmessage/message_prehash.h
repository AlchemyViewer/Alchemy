...
extern char const* const _PREHASH_MediaData;
extern char const* const _PREHASH_MediaType;
extern char const* const _PREHASH_MediaDesc;
extern char const* const _PREHASH_MediaWidth;
extern char const* const _PREHASH_MediaHeight;
extern char const* const _PREHASH_MediaLoop;
extern char const* const _PREHASH_MediaLinkSharing;
extern char const* const _PREHASH_MediaCurrentURL;
extern char const* const _PREHASH_MediaAllowNavigate;
extern char const* const _PREHASH_MediaPreventCameraZoom;
extern char const* const _PREHASH_MediaURLTimeout;
extern char const* const _PREHASH_DataExtended;
extern char const* const _PREHASH_DataBlockExtended;
extern char const* const _PREHASH_ColoName;
extern char const* const _PREHASH_CPUClassID;
extern char const* const _PREHASH_CPURatio;
extern char const* const _PREHASH_ProductName;
extern char const* const _PREHASH_ChannelVersion;
extern char const* const _PREHASH_TransactionInfo;
extern char const* const _PREHASH_IsSourceGroup;
extern char const* const _PREHASH_IsDestGroup;
extern char const* const _PREHASH_ItemDescription;
extern char const* const _PREHASH_TimeStamp;
extern char const* const _PREHASH_MonoScore;
extern char const* const _PREHASH_PublicURLs;
extern char const* const _PREHASH_NewData;
extern char const* const _PREHASH_ListInProfile;
extern char const* const _PREHASH_ModifyBlockExtended;
extern char const* const _PREHASH_SurfaceInfo;
extern char const* const _PREHASH_UVCoord;
extern char const* const _PREHASH_STCoord;
extern char const* const _PREHASH_Normal;
extern char const* const _PREHASH_Binormal;
extern char const* const _PREHASH_OwnerData;
extern char const* const _PREHASH_Options;
extern char const* const _PREHASH_CastsShadows;
extern char const* const _PREHASH_ExtraPhysics;
extern char const* const _PREHASH_PhysicsShapeType;
extern char const* const _PREHASH_Density;
extern char const* const _PREHASH_Friction;
extern char const* const _PREHASH_Restitution;
