...
EBakedTextureIndex LLAvatarAppearanceDictionary::findBakedByRegionName(std::string_view name)
{
	U8 index = 0;
...
EBakedTextureIndex LLAvatarAppearanceDictionary::findBakedByImageName(std::string_view name)
{
	U8 index = 0;
	while (index < BAKED_NUM_INDICES)
	{
