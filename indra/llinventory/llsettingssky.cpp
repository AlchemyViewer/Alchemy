...
LLSettingsSky::validation_list_t legacyHazeValidationList()
{
    ...
    if (legacyHazeValidation.empty())
    {
        legacyHazeValidation.push_back(LLSettingsBase::Validator(LLSettingsSky::SETTING_AMBIENT,             false,  LLSD::TypeArray, 
            boost::bind(&LLSettingsBase::Validator::verifyVectorMinMax, boost::placeholders::_1,
        ...
        legacyHazeValidation.push_back(LLSettingsBase::Validator(LLSettingsSky::SETTING_HAZE_DENSITY,        false,  LLSD::TypeReal,  
            boost::bind(&LLSettingsBase::Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0f)(5.0f)))));
        ...
        legacyHazeValidation.push_back(LLSettingsBase::Validator(LLSettingsSky::SETTING_DENSITY_MULTIPLIER,  false,  LLSD::TypeReal,  
            boost::bind(&LLSettingsBase::Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0001f)(2.0f)))));
        legacyHazeValidation.push_back(LLSettingsBase::Validator(LLSettingsSky::SETTING_DISTANCE_MULTIPLIER, false,  LLSD::TypeReal,
            boost::bind(&LLSettingsBase::Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0001f)(1000.0f)))));
    }
...
LLSettingsSky::validation_list_t rayleighValidationList()
{
    ...
    if (rayleighValidation.empty())
    {
        rayleighValidation.push_back(LLSettingsBase::Validator(LLSettingsSky::SETTING_DENSITY_PROFILE_WIDTH,      false,  LLSD::TypeReal,  
            boost::bind(&LLSettingsBase::Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0f)(32768.0f)))));

        rayleighValidation.push_back(LLSettingsBase::Validator(LLSettingsSky::SETTING_DENSITY_PROFILE_EXP_TERM,   false,  LLSD::TypeReal,  
            boost::bind(&LLSettingsBase::Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0f)(2.0f)))));
        ...
        rayleighValidation.push_back(LLSettingsBase::Validator(LLSettingsSky::SETTING_DENSITY_PROFILE_EXP_SCALE_FACTOR, false,  LLSD::TypeReal,  
            boost::bind(&LLSettingsBase::Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(-1.0f)(1.0f)))));
        ...
        rayleighValidation.push_back(LLSettingsBase::Validator(LLSettingsSky::SETTING_DENSITY_PROFILE_CONSTANT_TERM, false,  LLSD::TypeReal,  
            boost::bind(&LLSettingsBase::Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0f)(1.0f)))));
    }
...
const LLSettingsSky::validation_list_t& LLSettingsSky::validationList()
{
    ...
    {   // Note the use of LLSD(LLSDArray()()()...) This is due to an issue with the 
        ...
        validation.push_back(Validator(SETTING_CLOUD_COLOR,         true,  LLSD::TypeArray, 
            boost::bind(&Validator::verifyVectorMinMax, boost::placeholders::_1,
                LLSD(LLSDArray(0.0f)(0.0f)(0.0f)("*")),
        ...
        validation.push_back(Validator(SETTING_CLOUD_SCALE,         true,  LLSD::TypeReal,  
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.001f)(3.0f)))));
        validation.push_back(Validator(SETTING_CLOUD_SCROLL_RATE,   true,  LLSD::TypeArray, 
            boost::bind(&Validator::verifyVectorMinMax, boost::placeholders::_1,
                LLSD(LLSDArray(-50.0f)(-50.0f)),
                LLSD(LLSDArray(50.0f)(50.0f)))));
        validation.push_back(Validator(SETTING_CLOUD_SHADOW,        true,  LLSD::TypeReal,  
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0f)(1.0f)))));
        ...
        validation.push_back(Validator(SETTING_DOME_RADIUS,         false, LLSD::TypeReal,  
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(1000.0f)(2000.0f)))));
        validation.push_back(Validator(SETTING_GAMMA,               true,  LLSD::TypeReal,  
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0f)(20.0f)))));
        ...
        validation.push_back(Validator(SETTING_MAX_Y,               true,  LLSD::TypeReal,  
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0f)(10000.0f)))));
        validation.push_back(Validator(SETTING_MOON_ROTATION,       true,  LLSD::TypeArray, &Validator::verifyQuaternionNormal));
        validation.push_back(Validator(SETTING_MOON_SCALE,          false, LLSD::TypeReal,
                boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.25f)(20.0f))), LLSD::Real(1.0)));
        validation.push_back(Validator(SETTING_MOON_TEXTUREID,      false, LLSD::TypeUUID));
        validation.push_back(Validator(SETTING_MOON_BRIGHTNESS,     false,  LLSD::TypeReal, 
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0f)(1.0f)))));

        validation.push_back(Validator(SETTING_STAR_BRIGHTNESS,     true,  LLSD::TypeReal, 
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0f)(500.0f)))));
        ...
        validation.push_back(Validator(SETTING_PLANET_RADIUS,       true,  LLSD::TypeReal,  
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(1000.0f)(32768.0f)))));
        ...
        validation.push_back(Validator(SETTING_SUN_ARC_RADIANS,      true,  LLSD::TypeReal,  
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0f)(0.1f)))));
        ...
        validation.push_back(Validator(SETTING_SKY_DROPLET_RADIUS,      false,  LLSD::TypeReal,  
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(5.0f)(1000.0f)))));
