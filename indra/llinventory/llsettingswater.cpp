...
const LLSettingsWater::validation_list_t& LLSettingsWater::validationList()
{
    ...
    {   // Note the use of LLSD(LLSDArray()()()...) This is due to an issue with the 
        ...
        validation.push_back(Validator(SETTING_BLUR_MULTIPLIER, true, LLSD::TypeReal,
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(-0.5f)(0.5f)))));
        ...
        validation.push_back(Validator(SETTING_FOG_DENSITY, true, LLSD::TypeReal,
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(-10.0f)(10.0f)))));
        ...
        validation.push_back(Validator(SETTING_SCALE_ABOVE, true, LLSD::TypeReal,
            boost::bind(&Validator::verifyFloatRange, boost::placeholders::_1, LLSD(LLSDArray(0.0f)(3.0f)))));
