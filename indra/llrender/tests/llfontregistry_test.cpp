 ...
 *
 * The GL-requiring paths -- createFont allocating an atlas, getFont
 * caching the LLFontGL pointer, destroyGL releasing textures -- are in
 * llfontregistry_gl_test.cpp.
 *
