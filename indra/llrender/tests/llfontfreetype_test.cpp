 ...
 *
 * Pure-CPU. The rasterizer paths (getGlyphInfo, addGlyph,
 * collectGarbage), which route into LLFontBitmapCache::nextOpenPos and
 * gGL.bind, are in llfontfreetype_gl_test.cpp.
 *
