...
static_assert(std::is_trivially_copyable<LLColor4>::value, "LLColor4 must be trivially copyable");
static_assert(std::is_trivially_destructible<LLColor4>::value, "LLColor4 must be trivially destructible");
