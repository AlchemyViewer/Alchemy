...
static_assert(std::is_trivially_copyable<LLVector3>::value, "LLVector3 must be trivially copyable");
static_assert(std::is_trivially_destructible<LLVector3>::value, "LLVector3 must be trivially destructible");
