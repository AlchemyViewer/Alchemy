...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    vcpkg_download_distfile(
        ...
        FILENAME webrtc.windows_x86_64.tar.xz
...
elseif(VCPKG_TARGET_IS_OSX)
    ...
    if(VCPKG_OSX_ARCHITECTURES MATCHES "arm64")
        vcpkg_download_distfile(
            WEBRTC_ARCHIVE
            URLS https://github.com/AlchemyViewer/3p-webrtc/releases/download/m137.7151.04.20-r9/webrtc.macos_arm64.tar.xz
            FILENAME webrtc.macos_arm64.tar.xz
        ...
        vcpkg_download_distfile(
            WEBRTC_ARCHIVE
            URLS https://github.com/AlchemyViewer/3p-webrtc/releases/download/m137.7151.04.20-r9/webrtc.macos_x86_64.tar.xz
            FILENAME webrtc.macos_x86_64.tar.xz
...
elseif(VCPKG_TARGET_IS_LINUX)
    ...
    vcpkg_download_distfile(
        WEBRTC_ARCHIVE
        URLS https://github.com/AlchemyViewer/3p-webrtc/releases/download/m137.7151.04.20-r9/webrtc.ubuntu-22.04_x86_64.tar.xz
        FILENAME webrtc.ubuntu-22.04_x86_64.tar.xz
