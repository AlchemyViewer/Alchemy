...
set(
  AL_TEMPLATE_VERIFIER_MODE
  "development"
  CACHE STRING
  "Strictness of the message template check: development accepts an older or mixed template, production only the same or a newer one"
)
set_property(CACHE AL_TEMPLATE_VERIFIER_MODE PROPERTY STRINGS development production)
set(
  AL_TEMPLATE_VERIFIER_MASTER_URL
  "https://github.com/secondlife/master-message-template/raw/master/message_template.msg"
  CACHE STRING
  "Location of the master message template"
)
...
macro(check_message_template _target)
  ...
  add_custom_command(
    ...
    COMMAND
      ${CMAKE_COMMAND} -DTOOL=$<TARGET_FILE:template_verifier>
      ...
      -DMODE=${AL_TEMPLATE_VERIFIER_MODE} -DSTAMP=${message_template_stamp} -P
