                ...
                if (git_head MATCHES "^[0-9a-f]+$")
                    ...
                    foreach (head_file IN LISTS git_head_files)
                        if (EXISTS "${INDRA_SOURCE_DIR}/${head_file}")
                            set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${INDRA_SOURCE_DIR}/${head_file}")
                    ...
                    if (NOT AL_GIT_REVISION_COMMIT STREQUAL git_head)
                        ...
                        set(AL_GIT_REVISION_COMMIT "${git_head}" CACHE INTERNAL "The commit AL_GIT_REVISION_COUNT was taken for")
                        set(AL_GIT_REVISION_COUNT "${git_count}" CACHE INTERNAL "Number of commits reachable from AL_GIT_REVISION_COMMIT")
                    endif ()
