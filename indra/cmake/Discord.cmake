...
if(AL_USE_DISCORD)
  if(NOT AL_DISCORD_SDK_DIR)
    message(
      FATAL_ERROR
      "AL_USE_DISCORD needs the SDK: -DAL_DISCORD_SDK_DIR=<path to the unpacked Discord Social SDK>"
    )
  endif()
  ...
  find_path(
    ...
    discordpp.h
    PATHS "${AL_DISCORD_SDK_DIR}/include"
    NO_DEFAULT_PATH
    REQUIRED
  )
  find_library(
    DISCORD_SDK_LIBRARY
    discord_partner_sdk
    PATHS "${AL_DISCORD_SDK_DIR}/lib/release"
    NO_DEFAULT_PATH
    REQUIRED
  )
