  ...
  if (USE_LTO)
    if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
      if(INCREMENTAL_LINK)
        ...
        set(CMAKE_STATIC_LINKER_FLAGS "${CMAKE_STATIC_LINKER_FLAGS} /LTCG:STATUS")
...
if (LINUX)
  ...
  if (USE_LTO)
    if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
      set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -fuse-ld=lld -flto=thin -fwhole-program-vtables -fforce-emit-vtables")
      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fuse-ld=lld -flto=thin -fwhole-program-vtables -fforce-emit-vtables")
  ...
  if (USE_ASAN OR USE_LEAKSAN OR USE_UBSAN OR USE_THDSAN)
    if (HAS_DEBUG_OPTIMIZATION)
      set(CMAKE_CXX_FLAGS_RELEASE "-Og -fno-omit-frame-pointers ${CMAKE_CXX_FLAGS_RELEASE}")
    else()
      set(CMAKE_CXX_FLAGS_RELEASE "-O0 -fno-omit-frame-pointers ${CMAKE_CXX_FLAGS_RELEASE}")
    endif()
  else ()
